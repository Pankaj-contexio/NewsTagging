...
from models import social_collection, news_collection, users_collection
...
def generate_report_html(data, username, company, user):
    ...
    <div class="header">
        ...
        <h2><strong>Generated By:</strong> {user}</h2>
    ...
    for post in posts:
        ...
        if project_id:
            try:
                content_data = post['editedContent'][company][username].get(project_id)[-1]
            except Exception:
...
def download_doc():
    ...
    try:
        ...
        html_content = generate_report_html(data, username, company, user)
